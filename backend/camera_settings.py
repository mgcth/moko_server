...
class CameraSettings:
    ...
    def __init__(self):
        """
        Initialise Raspberry Pi camera settings with known values.
        """
        ...
        self.modes = {
            "V1": [
                CameraHardware(1, (2492, 1944), (0.1666, 15), True, True, "Full"),
                CameraHardware(0, (1920, 1080), (1, 30), True, False, "Partial"),
            ...
            "V2": [
                CameraHardware(1, (3280, 2464), (0.1, 15), True, True, "Full"),
                CameraHardware(2, (1640, 1232), (0.1, 40), True, False, "Full"),
                CameraHardware(0, (1920, 1080), (0.1, 30), True, False, "Partial"),
